...
Elm.Actions.BingoTermAction = Elm.Actions.BingoTermAction || {};
Elm.Actions.BingoTermAction.make = function (_elm) {
   "use strict";
   _elm.Actions = _elm.Actions || {};
   _elm.Actions.BingoTermAction = _elm.Actions.BingoTermAction || {};
   if (_elm.Actions.BingoTermAction.values) return _elm.Actions.BingoTermAction.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var UpdatePhrase = function (a) {    return {ctor: "UpdatePhrase",_0: a};};
   var Mark = function (a) {    return {ctor: "Mark",_0: a};};
   var Delete = function (a) {    return {ctor: "Delete",_0: a};};
   var Sort = {ctor: "Sort"};
   var NoOp = {ctor: "NoOp"};
   return _elm.Actions.BingoTermAction.values = {_op: _op
                                                ,NoOp: NoOp
                                                ,Sort: Sort
                                                ,Delete: Delete
                                                ,Mark: Mark
...
Elm.Models.BingoTerm = Elm.Models.BingoTerm || {};
Elm.Models.BingoTerm.make = function (_elm) {
   "use strict";
   _elm.Models = _elm.Models || {};
   _elm.Models.BingoTerm = _elm.Models.BingoTerm || {};
   if (_elm.Models.BingoTerm.values) return _elm.Models.BingoTerm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var BingoTerm = F4(function (a,b,c,d) {    return {phrase: a,points: b,wasSpoken: c,id: d};});
   return _elm.Models.BingoTerm.values = {_op: _op,BingoTerm: BingoTerm};
};
Elm.Models = Elm.Models || {};
Elm.Models.NewBingoTerm = Elm.Models.NewBingoTerm || {};
Elm.Models.NewBingoTerm.make = function (_elm) {
   "use strict";
   _elm.Models = _elm.Models || {};
   _elm.Models.NewBingoTerm = _elm.Models.NewBingoTerm || {};
   if (_elm.Models.NewBingoTerm.values) return _elm.Models.NewBingoTerm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var NewBingoTerm = F2(function (a,b) {    return {phrase: a,points: b};});
   return _elm.Models.NewBingoTerm.values = {_op: _op,NewBingoTerm: NewBingoTerm};
};
Elm.Definitions = Elm.Definitions || {};
Elm.Definitions.make = function (_elm) {
   "use strict";
   _elm.Definitions = _elm.Definitions || {};
   if (_elm.Definitions.values) return _elm.Definitions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models$BingoTerm = Elm.Models.BingoTerm.make(_elm),
   $Models$NewBingoTerm = Elm.Models.NewBingoTerm.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var AppState = F2(function (a,b) {    return {entries: a,bingoItemInput: b};});
   return _elm.Definitions.values = {_op: _op,AppState: AppState};
};
...
Elm.BingoUtils.make = function (_elm) {
   ...
   var onFormSubmit = F2(function (address,action) {
   ...
   return _elm.BingoUtils.values = {_op: _op,onFormSubmit: onFormSubmit,onInput: onInput,parseInt: parseInt};
};
Elm.Views = Elm.Views || {};
Elm.Views.Header = Elm.Views.Header || {};
Elm.Views.Header.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.Header = _elm.Views.Header || {};
   if (_elm.Views.Header.values) return _elm.Views.Header.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var headerView = function (title) {
      var children = _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text(title)]))]);
      var attributes = _U.list([]);
      return A2($Html.header,attributes,children);
   };
   return _elm.Views.Header.values = {_op: _op,headerView: headerView};
};
Elm.Views = Elm.Views || {};
Elm.Views.Footer = Elm.Views.Footer || {};
Elm.Views.Footer.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.Footer = _elm.Views.Footer || {};
   if (_elm.Views.Footer.values) return _elm.Views.Footer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var footerView = A2($Html.footer,
   _U.list([]),
   _U.list([A2($Html.a,
   _U.list([$Html$Attributes.href("http://availableforfriendship.com"),A2($Html$Attributes.attribute,"target","_blank")]),
   _U.list([$Html.text("More over here!")]))]));
   return _elm.Views.Footer.values = {_op: _op,footerView: footerView};
};
Elm.Views = Elm.Views || {};
Elm.Views.DeleteButton = Elm.Views.DeleteButton || {};
Elm.Views.DeleteButton.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.DeleteButton = _elm.Views.DeleteButton || {};
   if (_elm.Views.DeleteButton.values) return _elm.Views.DeleteButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$BingoTermAction = Elm.Actions.BingoTermAction.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var deleteButtonView = F2(function (address,id) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("delete"),A2($Html$Events.onClick,address,$Actions$BingoTermAction.Delete(id))]),
      _U.list([$Html.text("")]));
   });
   return _elm.Views.DeleteButton.values = {_op: _op,deleteButtonView: deleteButtonView};
};
Elm.Views = Elm.Views || {};
Elm.Views.EntryListItem = Elm.Views.EntryListItem || {};
Elm.Views.EntryListItem.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.EntryListItem = _elm.Views.EntryListItem || {};
   if (_elm.Views.EntryListItem.values) return _elm.Views.EntryListItem.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$BingoTermAction = Elm.Actions.BingoTermAction.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Views$DeleteButton = Elm.Views.DeleteButton.make(_elm);
   var _op = {};
   var entryListItemView = F2(function (address,listItem) {
      return A2($Html.li,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "bingo-list-item",_1: true},{ctor: "_Tuple2",_0: "highlight",_1: listItem.wasSpoken}]))
              ,A2($Html$Events.onClick,address,$Actions$BingoTermAction.Mark(listItem.id))]),
      _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("phrase")]),_U.list([$Html.text(listItem.phrase)]))
              ,A2($Html.span,_U.list([$Html$Attributes.$class("points")]),_U.list([$Html.text($Basics.toString(listItem.points))]))
              ,A2($Views$DeleteButton.deleteButtonView,address,listItem.id)]));
   });
   return _elm.Views.EntryListItem.values = {_op: _op,entryListItemView: entryListItemView};
};
Elm.Views = Elm.Views || {};
Elm.Views.TotalListItem = Elm.Views.TotalListItem || {};
Elm.Views.TotalListItem.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.TotalListItem = _elm.Views.TotalListItem || {};
   if (_elm.Views.TotalListItem.values) return _elm.Views.TotalListItem.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var totalListItemView = function (points) {
      return A2($Html.li,
   ...
   return _elm.Views.TotalListItem.values = {_op: _op,totalListItemView: totalListItemView};
};
Elm.Views = Elm.Views || {};
Elm.Views.EntryList = Elm.Views.EntryList || {};
Elm.Views.EntryList.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.EntryList = _elm.Views.EntryList || {};
   if (_elm.Views.EntryList.values) return _elm.Views.EntryList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Views$EntryListItem = Elm.Views.EntryListItem.make(_elm),
   $Views$TotalListItem = Elm.Views.TotalListItem.make(_elm);
   var _op = {};
   var totalPoints = function (entries) {
      return A3($List.foldl,F2(function (entry,sum) {    return sum + entry.points;}),0,A2($List.filter,function (_) {    return _.wasSpoken;},entries));
   };
   var entryListView = F2(function (address,listItems) {
      var totalListItem = $Views$TotalListItem.totalListItemView(totalPoints(listItems));
      var getListItems = A2($List.map,$Views$EntryListItem.entryListItemView(address),listItems);
      var listItemsAndTotal = A2($Basics._op["++"],getListItems,_U.list([totalListItem]));
      return A2($Html.ul,_U.list([]),listItemsAndTotal);
   });
   return _elm.Views.EntryList.values = {_op: _op,entryListView: entryListView};
};
Elm.Views = Elm.Views || {};
Elm.Views.SortButton = Elm.Views.SortButton || {};
Elm.Views.SortButton.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.SortButton = _elm.Views.SortButton || {};
   if (_elm.Views.SortButton.values) return _elm.Views.SortButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$BingoTermAction = Elm.Actions.BingoTermAction.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var sortButtonView = function (address) {
      return A2($Html.button,
      _U.list([$Html$Attributes.$class("btn btn-sort"),A2($Html$Events.onClick,address,$Actions$BingoTermAction.Sort)]),
      _U.list([$Html.text("Sort")]));
   };
   return _elm.Views.SortButton.values = {_op: _op,sortButtonView: sortButtonView};
};
Elm.Views = Elm.Views || {};
Elm.Views.NewTermForm = Elm.Views.NewTermForm || {};
Elm.Views.NewTermForm.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.NewTermForm = _elm.Views.NewTermForm || {};
   if (_elm.Views.NewTermForm.values) return _elm.Views.NewTermForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$BingoTermAction = Elm.Actions.BingoTermAction.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var newTermFormView = F2(function (address,model) {
      return A2($Html.form,
      _U.list([A2($BingoUtils.onFormSubmit,address,$Actions$BingoTermAction.NoOp)]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("phrase")
                      ,$Html$Attributes.value(model.phrase)
                      ,$Html$Attributes.name("phrase")
                      ,$Html$Attributes.autofocus(true)
                      ,A2($BingoUtils.onInput,address,$Actions$BingoTermAction.UpdatePhrase)]),
              _U.list([]))
              ,A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("points")
                      ,$Html$Attributes.value(model.points)
                      ,$Html$Attributes.name("points")
                      ,A2($BingoUtils.onInput,address,$Actions$BingoTermAction.UpdatePoints)]),
              _U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("btn"),A2($Html$Events.onClick,address,$Actions$BingoTermAction.Add)]),
              _U.list([$Html.text("Add")]))]));
   });
   return _elm.Views.NewTermForm.values = {_op: _op,newTermFormView: newTermFormView};
};
Elm.Views = Elm.Views || {};
Elm.Views.App = Elm.Views.App || {};
Elm.Views.App.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.App = _elm.Views.App || {};
   if (_elm.Views.App.values) return _elm.Views.App.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$BingoTermAction = Elm.Actions.BingoTermAction.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Definitions = Elm.Definitions.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Views$EntryList = Elm.Views.EntryList.make(_elm),
   $Views$Footer = Elm.Views.Footer.make(_elm),
   $Views$Header = Elm.Views.Header.make(_elm),
   $Views$NewTermForm = Elm.Views.NewTermForm.make(_elm),
   $Views$SortButton = Elm.Views.SortButton.make(_elm);
   var _op = {};
   var appView = F2(function (address,appState) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([$Views$Header.headerView("bingo!")
              ,A2($Views$NewTermForm.newTermFormView,address,appState.bingoItemInput)
              ,A2($Views$EntryList.entryListView,address,appState.entries)
              ,$Views$SortButton.sortButtonView(address)
              ,$Views$Footer.footerView]));
   });
   return _elm.Views.App.values = {_op: _op,appView: appView};
};
Elm.Bingo = Elm.Bingo || {};
Elm.Bingo.make = function (_elm) {
   ...
   $Views$App = Elm.Views.App.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "Delete": var getRemainingEntries = A2($List.filter,function (entry) {    return !_U.eq(entry.id,_p0._0);},model.entries);
           return _U.update(model,{entries: getRemainingEntries});
         case "Mark": var updateEntry = function (entry) {
              return _U.eq(entry.id,_p0._0) ? _U.update(entry,{wasSpoken: $Basics.not(entry.wasSpoken)}) : entry;
           };
           return _U.update(model,{entries: A2($List.map,updateEntry,model.entries)});
         case "UpdatePhrase": return _U.update(model,{bingoItemInput: A2($Models$NewBingoTerm.NewBingoTerm,_p0._0,model.bingoItemInput.points)});
         case "UpdatePoints": return _U.update(model,{bingoItemInput: A2($Models$NewBingoTerm.NewBingoTerm,model.bingoItemInput.phrase,_p0._0)});
         default: var entriesCount = $List.length(model.entries);
           var nextId = entriesCount + 1;
           var phrase = model.bingoItemInput.phrase;
           var points = $BingoUtils.parseInt(model.bingoItemInput.points);
           var nextBingoItem = A4($Models$BingoTerm.BingoTerm,phrase,points,false,nextId);
           var updatedEntries = A2($Basics._op["++"],model.entries,_U.list([nextBingoItem]));
           return _U.update(model,{entries: updatedEntries,bingoItemInput: A2($Models$NewBingoTerm.NewBingoTerm,"","")});}
   });
   var appState = {entries: _U.list([A4($Models$BingoTerm.BingoTerm,"Future-Proof",100,false,1)
                                    ,A4($Models$BingoTerm.BingoTerm,"Disrupt",150,false,2)
                                    ,A4($Models$BingoTerm.BingoTerm,"We\'re Agile",500,false,3)
                                    ,A4($Models$BingoTerm.BingoTerm,"Rockstar Ninja",350,false,4)
                                    ,A4($Models$BingoTerm.BingoTerm,"Thought Leader",250,false,5)])
                  ,bingoItemInput: A2($Models$NewBingoTerm.NewBingoTerm,"","")};
   var main = $StartApp$Simple.start({model: appState,view: $Views$App.appView,update: update});
   return _elm.Bingo.values = {_op: _op,appState: appState,update: update,main: main};
};

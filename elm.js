...
Elm.Views.EntryList.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var entryListView = A2($Html.ul,_U.list([]),_U.list([A2($Html.li,_U.list([]),_U.list([$Html.text("Future-Proof")]))]));
...
Elm.Views.App.make = function (_elm) {
   ...
   var appView = A2($Html.div,_U.list([$Html$Attributes.id("container")]),_U.list([pageHeader("bingo!"),$Views$EntryList.entryListView,pageFooter]));
